...
*This approach is very generalized and does not represent the actual economic trends of 2022. This is for demonstration purposes to test and use the model to make predictions on a set of variables only.*
```{r}
...
```
**The cross-validated MSE of the Random Forests model is reported to be 3.76294e+09.** Based on the LASSO graph, we can consider the estimated best case with 4 predictors with \lambda that generates the smallest MSE. Next, we'll predict the housing prices for 2022 based on the 3 scenarios.
